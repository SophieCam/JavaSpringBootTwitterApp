package com.tts.TwitterApp.configuration;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    //this autowire's our encoder, thus injecting our dependency
    @Autowired
    private BCryptPasswordEncoder bCryptPasswordEncoder;

    //this autowire's a reference to our datasource
    @Autowired
    private DataSource dataSource;

    //these are queries defined in our application.properties
